...
\hypersetup{
  pdftitle={ {{- personal.name }} - CV},
  pdfauthor={ {{- personal.name -}} },
  pdfsubject={ {{- personal.title -}} },
  pdfkeywords={ {{- skills | map(attribute='label') | join(', ') -}} },
}
\usepackage{titlesec}
\usepackage{enumitem}
...
{%- endif %}
{%- if skills %}
{\small\centering {{ skills | map(attribute='label') | join(' \\textbullet\\ ') }}\par}
{%- endif %}
{%- endif %}
