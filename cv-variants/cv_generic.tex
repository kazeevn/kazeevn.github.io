...
\end{itemize}
\vspace{2pt}
{\leftskip\projindent\textbf{ML for predicting properties of defects in 2D crystals}\artifacts{ \href{https://www.nature.com/articles/s41699-023-00369-1}{paper 1} \textperiodcentered{} \href{https://www.nature.com/articles/s41524-023-01062-z}{paper 2} \textperiodcentered{} \href{https://scholar.google.com/citations?view\_op=view\_citation&hl=en&user=vamy2okAAAAJ&sortby=pubdate&citation\_for\_view=vamy2okAAAAJ:uAPFzskPt0AC}{patent} \textperiodcentered{} \href{https://github.com/HSE-LAMBDA/ai4material\_design}{code} }\par}
\begin{itemize}[leftmargin=\projbulletindent]
  ...
  \item Optimized training and inference workflows, reducing memory usage by 4x and GPU operations by 8x
  \item Developed code for reproducible parallel running of machine learning experiments
  \item Led a team of 3
\end{itemize}
\smallskip

\textsc{\textbf{Constructor Group}} \textit{Machine Learning Consultant} \hfill\textbf{2021--present}\par
\smallskip
...
\begin{enumerate}[leftmargin=1.5em,topsep=1pt,itemsep=1pt,parsep=0pt]
  ...
  \item M. Borisyak and \textbf{N. Kazeev}. \href{https://doi.org/10.1088\%2F1748-0221\%2F14\%2F08\%2Fp08020}{Machine Learning on data with sPlot background subtraction}. Journal of Instrumentation 14.08 (2019). \textbf{Alphabetic order, I'm the corresponding author.}
