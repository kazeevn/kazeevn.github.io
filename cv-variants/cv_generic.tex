...
\section{Skills}
\begin{itemize}
  \item \textbf{Generative modeling for scientific data} --- GANs, autoregressive transformers, and diffusion; from fast detector simulation to symmetry-aware crystal generation.
...
\end{itemize}
ML \& AI \textbullet\ Python \textbullet\ PyTorch \textbullet\ C++ \textbullet\ HPC \textbullet\ Physics \textbullet\ Research Writing \& Speaking \textbullet\ Leadership \& Mentorship
