...
\textsc{\textbf{Perfomax}}\quad{\small\color{black!55}\itshape AI Advisor} \hfill\textbf{2026--present}\par
\smallskip
...
\begin{itemize}[leftmargin=\projbulletindent]
  ...
  \item Main organizer of the \href{https://multiscale-ai.github.io/}{ICLR 2025 Workshop on Machine Learning Multiscale Processes}.
\end{itemize}
\vspace{2pt}
...
\textit{PhD in Computer Science}, supervisor \href{https://www.linkedin.com/profile/view?id=2422149}{Andrey Ustyuzhanin}; \href{https://repository.cern/records/034yx-nt191}{Machine Learning for particle identification in the LHCb detector}.\par
\smallskip

\textbf{Sapienza --- Universita di Roma}\hfill\textbf{2016--2020}\par
\textit{PhD in Physics} (double degree with HSE), supervisor \href{https://it.linkedin.com/in/barbara-sciascia-234935a}{Barbara Sciascia}.\par
\smallskip
...
\textit{MS in Physics} (2014--2016): Optimisation of data processing of the LHCb experiment.

\textit{BS in Physics} (2010--2014): Study of the quantum states of the electrons in nonideal plasma and selected molecules using wave packet molecular dynamics with packet splitting.\par
\smallskip

\textbf{International Junior Science Olympiad (IJSO)}\hfill\textbf{2008}\par
Silver medal (held in Korea).\par
\smallskip
...
\section{Service}
\begin{itemize}
  \item Reviewer for NeurIPS, RSC Advances, Machine Learning: Science and Technology
