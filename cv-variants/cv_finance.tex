...
\hypersetup{
  ...
  pdfkeywords={ML \& AI, Python, PyTorch, C++, Physics},
}
\usepackage{titlesec}
\usepackage{enumitem}
...
% template, so `finance` is a literal keyword here (empty for the
% generic CV, which prints everything).
\defbibfilter{cvicml}{ \keyword{icml2026} and \keyword{finance} }
\defbibfilter{cvselected}{ not \keyword{icml2026} and \keyword{finance} }
...
\end{itemize}
{\small\centering ML \& AI \textbullet\ Python \textbullet\ PyTorch \textbullet\ C++ \textbullet\ Physics\par}
