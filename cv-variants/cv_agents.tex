...
\hypersetup{
  ...
  pdfsubject={Research Scientist focusing on AI Agents \& ML Reliability},
  pdfkeywords={ML \& AI, Python, PyTorch, HPC, Physics, Research Writing \& Speaking, Leadership \& Mentorship},
}
\usepackage{titlesec}
\usepackage{enumitem}
...
% template, so `agents` is a literal keyword here (empty for the
% generic CV, which prints everything).
\defbibfilter{cvicml}{ \keyword{icml2026} and \keyword{agents} }
\defbibfilter{cvselected}{ not \keyword{icml2026} and \keyword{agents} }
...
\begin{center}
  ...
  \textit{ Research Scientist focusing on AI Agents \& ML Reliability }
\end{center}
...
\end{itemize}
{\small\centering ML \& AI \textbullet\ Python \textbullet\ PyTorch \textbullet\ HPC \textbullet\ Physics \textbullet\ Research Writing \& Speaking \textbullet\ Leadership \& Mentorship\par}
