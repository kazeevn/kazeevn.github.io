...
% template, so `atomistic` is a literal keyword here (empty for the
% generic CV, which prints everything).
\defbibfilter{cvicml}{ \keyword{icml2026} and \keyword{atomistic} }
\defbibfilter{cvselected}{ not \keyword{icml2026} and \keyword{atomistic} }
